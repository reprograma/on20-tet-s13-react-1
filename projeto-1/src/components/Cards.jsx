  ...
  return(
    <div className="cards_container">
      <div className="card">
        ...
        />
        <Image estilo="imagem" link="https://c.tenor.com/zcBnwpK04MUAAAAC/thinking-issa-rae.gif" />
      </div>
      <div className="card">
        <Subtitle texto="HTML"/>
        <Text 
        ...
        />
        <Image estilo="imagem" link="https://c.tenor.com/nVmk2ThKqzsAAAAC/flexing-issa-rae.gif" />
      </div>
      <div className="card">
        <Subtitle texto="CSS"/>
        <Text 
        ...
        />
        <Image estilo="imagem" link="https://media.giphy.com/media/3oz8xuZupCwQf6ejUk/giphy.gif" />
      </div>
      <div className="card">
        ...
        />
        <Image estilo="imagem" link="https://i.gifer.com/fxl3.gif" />
      </div>
    </div>
  )
}